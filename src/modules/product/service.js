 ...
 * @returns {*}
 */
export const getRatingProductReviews = product_id => request.get(`/mobile-builder/v1/rating-count?product_id=${product_id}`);

/**
 *  Get rating product reviews
 * @returns {*}
 */
export const addProductReviews = data => request.post(`/mobile-builder/v1/reviews`, data);
